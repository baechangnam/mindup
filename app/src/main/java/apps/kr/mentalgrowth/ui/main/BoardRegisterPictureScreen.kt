...
@Composable
fun BoardRegisterPictureScreen(navController: NavController, code : String,  idx: String? = null, viewModel: MainViewModel = viewModel()) {
    // 제목, 내용 입력 상태
        ...
        content = { innerPadding ->
            Column(
                ...
                Button(onClick = { launcher.launch("image/*") }) {
                    ...
                    Text(text = "이미지 첨부",  style = MaterialTheme.typography.body2)
